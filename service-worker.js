...
if (workbox) {
  ...
  workbox.precaching.precacheAndRoute([
    ...
    { url: '/js/data/connections.js', revision: '2' },
    ...
    { url: '/js/map/svg-overlay.js', revision: '2' },
    { url: '/js/map/canvas-renderer.js', revision: '2' },
    { url: '/js/ui/filters.js', revision: '1' },
    { url: '/js/ui/sidebar.js', revision: '2' },
    { url: '/js/ui/info-panel.js', revision: '1' },
    { url: '/js/ui/mobile-sheet.js', revision: '1' },
    { url: '/js/ui/tooltip.js', revision: '2' },
